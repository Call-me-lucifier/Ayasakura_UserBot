...
UNAPPROVED_MSG = (
    "`Yooo!.\n\n`"
    "`Seems like your Pm isn't approved yet\n\n`"
    "`But, No worry! Just wait untill i am back.\n\n`"
    "`If i am not replying yet, try to mention me in a group. Untill then please to not spam my PM.`")
# =================================================================
